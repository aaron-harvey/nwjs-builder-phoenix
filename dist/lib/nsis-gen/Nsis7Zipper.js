...
var Nsis7Zipper = /** @class */ (function (_super) {
    ...
    Nsis7Zipper.getMakeInstallerFiles = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, "SetOutPath \"$INSTDIR\"\nSetCompress off\nFile \"" + path_1.win32.normalize(path_1.resolve(path)) + "\"\nNsis7z::ExtractWithDetails \"$OUTDIR\\" + path_1.basename(path) + "\" \"$(INSTALLING) %s...\"\nDelete \"$OUTDIR\\" + path_1.basename(path) + "\""];
            });
        });
    };
    Nsis7Zipper.prototype.makeInstallerFiles = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Nsis7Zipper.getMakeInstallerFiles(this.path)];
